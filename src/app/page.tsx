    ...
    <div className="relative font-sans text-white selection:bg-indigo-300 selection:text-indigo-900">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <div className="relative max-w-4xl flex flex-col items-center animate-in fade-in zoom-in duration-1000 slide-in-from-bottom-10">
          ...
          <h1 className="mt-16 text-5xl font-extrabold tracking-tight sm:text-7xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60 drop-shadow-sm mb-6">
            Your Mind<br />
