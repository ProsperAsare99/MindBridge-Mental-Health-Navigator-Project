...
import { MotionDiv, MotionMain, MotionSection, MotionH1, MotionP } from "@/components/motion-wrappers";
      ...
      <main className="relative z-10 pt-32 pb-24 px-6 md:px-24">
        ...
        <section className="max-w-4xl mx-auto mb-32 text-center">
          <MotionDiv
            ...
            className="space-y-8"
          >
            <MotionDiv variants={itemVariants} className="inline-flex items-center gap-2.5 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-[10px] font-black uppercase tracking-widest text-primary backdrop-blur-md shadow-sm">
              <Compass className="h-3.5 w-3.5" />
              Our Mission
            </MotionDiv>
            <MotionH1 variants={itemVariants} className="text-6xl md:text-9xl font-black tracking-tighter leading-none pt-4">
              Bridging the Gap in <br />
              <span className="text-dashed-underline">Student Well-being.</span>
            </MotionH1>
            <MotionP variants={itemVariants} className="text-xl md:text-3xl font-medium text-muted-foreground leading-relaxed max-w-2xl mx-auto">
